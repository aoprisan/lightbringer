...
function start(): void {
  ...
  // A resting thumb trembles a few px; without slack that tremor creeps the hero
  // and breaks the stand-still inscription the whole game hangs on.
  const STICK_DEAD = 8;
...
if (typeof globalThis !== "undefined" && testGlobal.__PG_TEST__) {
  testGlobal.__pg = {
    ...
    K: {
      ...
      OBSTACLE_RADIUS, DWELLING_HEAL, HEAL_CAP, CONSTELLATION_HEAL, FENCE_HALF, PATHWAY_HALF, PATHWAY_BOOST, PATHWAY_INSCRIBE_MUL,
